            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 max-w-[540px] lg:mb-0">
                ...
                <Button
                  ...
                  regStyle={
                    "inline-flex items-center justify-center rounded-md border border-primary bg-primary px-7 py-3 text-center text-base font-medium text-white"
                  }
                  hoverStyle={"hover:border-blue-dark hover:bg-blue-dark"}
